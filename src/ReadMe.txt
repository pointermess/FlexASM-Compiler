========================================================================
    KONSOLENANWENDUNG: FlexASM Compiler-Projektübersicht
========================================================================

Diese FlexASM Compiler-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FlexASM Compiler-Anwendung besteht.


FlexASM Compiler.vcxproj
...
FlexASM Compiler.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FlexASM Compiler.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
